...
public class ResiduoListGenerator : MonoBehaviour
{
    ...
    private readonly List<GameObject> spawnedResiduoItems = new();
    private readonly Dictionary<string, Toggle> subcategoryToggles = new();
    private readonly HashSet<string> activeSubcategories = new();

    private List<Residuo> allResiduos = new();
    private List<string> orderedSubcategories = new();
